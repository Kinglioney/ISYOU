...
/** 获取缩略图路径 */
#define URL_LASER     @"download2?folderName=激光类&type=IPHONE"
#define URL_INJECTION @"download2?folderName=注射类&type=IPHONE"
#define URL_PLASTIC   @"download2?folderName=整形外科&type=IPHONE"
#define URL_HEALTH    @"download2?folderName=大健康类&type=IPHONE"
/** 服务器存放崩溃标志的路径 */
